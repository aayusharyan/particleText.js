<template>
  <div class="app">
    <div class="container">
      <h1>ParticleText.js + Nuxt</h1>
      <p class="subtitle">Interactive particle text animation built with Nuxt 3</p>
...
onMounted(async () => {
  if (process.client && canvasRef.value) {
    const initParticleJS = (await import('particletext.js')).default;

    particleInstance = initParticleJS(canvasRef.value, {
      text: 'Particle Text',
      colors: ['#00DC82', '#00C58E', '#108775'],
      fontSize: 80,
      particleRadius: {
        xxxs: { base: 1, rand: 1 },
        sm: { base: 1.5, rand: 1 },
