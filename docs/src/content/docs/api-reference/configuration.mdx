...
<CanvasExample
  title="Weighted Distribution (Red: 80%, Others: 5% each)"
  config={{
    text: 'WEIGHTED',
    colors: [
      { color: '#FF6B6B', weight: 16 },
      { color: '#FFD93D', weight: 1 },
      { color: '#6BCF7F', weight: 1 },
      { color: '#4ECDC4', weight: 1 },
      { color: '#695aa6', weight: 1 }
    ],
    fontSize: 100
  }}
  height={300}
